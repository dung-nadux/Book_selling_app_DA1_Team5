package fpoly.dungnm.assignment_resapi.activities;
...
import fpoly.dungnm.assignment_resapi.fragments.Order_Admin_Fragment;
import fpoly.dungnm.assignment_resapi.fragments.Product_Admin_Fragment;
import fpoly.dungnm.assignment_resapi.fragments.ProfileFragment;
import fpoly.dungnm.assignment_resapi.fragments.Thong_Ke_Fragment;
import fpoly.dungnm.assignment_resapi.fragments.User_Admin_Fragment;
...
public class MainAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav_user_admin.setOnClickListener(v -> loadFragment(new User_Admin_Fragment()));
    ...
    private void onFragmentChanged() {
        ...
        if (currentFragment instanceof ProfileFragment) {
            ...
            nav_bar_admin.setVisibility(LinearLayout.GONE);
        } else if (currentFragment instanceof User_Admin_Fragment) {
            nav_bar_admin.setVisibility(LinearLayout.GONE);
