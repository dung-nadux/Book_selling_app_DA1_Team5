...
import fpoly.dungnm.assignment_resapi.activities.LoginActivity;
import fpoly.dungnm.assignment_resapi.activities.MainAdminActivity;
                    ...
                    if (response.isSuccessful()) {
                        if (response.body() != null) {
                            if (response.body().getStatus() == 200) {
                                ...
                                Toast.makeText(getContext(), "Cập nhật thành công" + userNew.getBalance(), Toast.LENGTH_SHORT).show();
