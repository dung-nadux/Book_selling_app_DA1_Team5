...
import fpoly.dungnm.assignment_resapi.adapter.CartAdapter;
import fpoly.dungnm.assignment_resapi.adapter.OrderDetailAdapter;
                    ...
                    public void onResponse(Call<ResponeData<Order>> call, Response<ResponeData<Order>> response) {
                        if (response.isSuccessful()) {
                            if (response.body().getStatus() == 200) {
                                Toast.makeText(getContext(), "Đơn hàng đã được xóa", Toast.LENGTH_SHORT).show();
                ...
                if (response.body() != null) {
                    if (response.body().getStatus() == 200) {
                        ...
                        if (user.getStatus().equals("Banned")) {
                            ...
                            Toast.makeText(getContext(), "balance: " + balance, Toast.LENGTH_SHORT).show();
                        }
