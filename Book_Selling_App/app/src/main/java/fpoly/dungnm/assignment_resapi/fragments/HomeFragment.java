...
import fpoly.dungnm.assignment_resapi.MainActivity;
import fpoly.dungnm.assignment_resapi.R;
import fpoly.dungnm.assignment_resapi.adapter.ViewPagerHomeAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewPager.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                tab_phone.setImageResource(position == 0 ? R.drawable.bt_phone_on : R.drawable.bt_phone_off);
                tab_laptop.setImageResource(position == 1 ? R.drawable.bt_laptop_on : R.drawable.bt_laptop_off);
                tab_accessory.setImageResource(position == 2 ? R.drawable.bt_accessory_on : R.drawable.bt_accessory_off);
            }
        });
